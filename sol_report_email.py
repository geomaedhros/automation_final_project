...
sol_reports.generate_report(attachment, title, paragraph)
...
message = sol_email.generate_email(sender, receiver, subject, body, attachment)
sol_email.send_email(message)